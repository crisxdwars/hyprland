...
* wl-clipboard, grim & slurp: Resources For Screenshot System
* ttf-jetbrains-mono-nerd: Font for everything
* noto-fonts-cjk: Font Support For Chinese, Japanese, Korean
* noto-fonts-emoji: Emoji Support
* zip: Used to Zip & Unzip Files
* pavucontrol: Input & Output Controller like Microphone & Speakers
...
### Misc
* SUPER + I: Hide/Show Waybar
* SUPER + L: Open Settings
* SUPER + ALT + R: Screen Record (Internal sounds only)
